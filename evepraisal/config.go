...
func init() {
	...
	viper.SetDefault("https_domain-whitelist", []string{"appraisal.new-eden.io"})
	viper.SetDefault("letsencrypt_email", "")
	viper.SetDefault("db_path", "/home/vscode/db")
	viper.SetDefault("backup_path", "/home/vscode/db/backups/")
